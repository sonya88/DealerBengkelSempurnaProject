...
using Dealer_BengkelSempurna.transaksi.Service;
...
namespace Dealer_BengkelSempurna
{
    static class Program
    {
        ...
        {
            return "integrated security = true; data source = LAPTOP-INB51L5O\\MSSQLSERVER01; initial catalog = PROJEK08";
        }
