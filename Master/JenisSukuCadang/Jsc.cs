...
namespace Dealer_BengkelSempurna.Master.JenisSukuCadang
{
    public partial class Jsc : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'pROJEK8.ViewJenisSukuCadang' table. You can move, or remove it, as needed.
            this.viewJenisSukuCadangTableAdapter.Fill(this.pROJEK8.ViewJenisSukuCadang);
            RefreshDg();
        ...
        private void dgvPosisi_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (lbJudul.Text == "TAMBAH POSISI")
            {
        ...
        private void btnCari_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string connectionString = "integrated security = true; data source = LAPTOP-INB51L5O\\MSSQLSERVER01; initial catalog = PROJEK08";
                SqlConnection connection = new SqlConnection(connectionString);
                SqlCommand search = new SqlCommand("sp_CariJenisSukuCadang", connection);
            ...
            dgvPosisi.Columns[1].HeaderCell.Value = "Kode_Jenis_SukuCadang";
            dgvPosisi.Columns[2].HeaderCell.Value = "Nama_Jenis_SukuCadang";
            dgvPosisi.Columns[3].HeaderCell.Value = "Detail_Jenis_SukuCadang";
            dgvPosisi.Columns[1].Width = 100;
            dgvPosisi.Columns[2].Width = 100;
            dgvPosisi.Columns[3].Width = 125;
